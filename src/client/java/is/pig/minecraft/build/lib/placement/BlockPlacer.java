 ...
 * Handles all the client-side tricks: packet sending, prediction, swing animation, delays, etc.
 */
public class BlockPlacer {
    ...
    public static boolean placeBlock(BlockHitResult hitResult, InteractionHand hand) {
        ...
        if (success) {
            PiggyBuildClient.LOGGER.info("[BlockPlacer] Placement successful via GameMode");
            return true;
        }
        ...
        if (success) {
            PiggyBuildClient.LOGGER.info("[BlockPlacer] Placement successful via Packet");
            return true;
        }
